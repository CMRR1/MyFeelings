...
class MainActivity : AppCompatActivity() {
    ...
    fun actualizarGrafica(){
        ...
        graphVerryHappy.background=CustomBarDrawable(this, Emociones("Muy Feliz", pVH, R.color.mustard, veryHappy))
        graphVerryHappy.background=CustomBarDrawable(this, Emociones("Feliz", pH, R.color.orange,happy))
        graphVerryHappy.background=CustomBarDrawable(this, Emociones("Neutral", pN, R.color.greenie, neutral))
        graphVerryHappy.background=CustomBarDrawable(this, Emociones("Triste", pS, R.color.blue, sad))
        graphVerryHappy.background=CustomBarDrawable(this, Emociones("Muy Triste", pVS, R.color.deepBlue, verySad))
